...
public class JWTUtil {
    ...
    private SpJwtProperties properties;
    ...
    public String generate(String userId) {
        log.debug("generate(String userId)={}", userId);
        return generate(userId, TokenType.access);
    }

    public String generate(String userId, TokenType type) {
        log.debug("generate(String userId, TokenType type)={}, {}", userId, type.toString());
    ...
    public VerifyResult verify(String token) {
        log.debug("verify(String token)={}", token);
        try {
