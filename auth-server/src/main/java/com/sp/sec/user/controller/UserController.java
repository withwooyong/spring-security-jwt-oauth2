...
public class UserController {
    ...
    public Optional<User> addAuthority(@RequestParam String userId, @RequestParam String authority) {
    ...
    public Optional<User> removeAuthority(@RequestParam String userId, @RequestParam String authority) {
        userService.findUser(userId).ifPresent(user -> {
